    ...
    <!-- colorpicker -->
    <link href="<?php echo base_url("upload/css/colorpicker/bootstrap-colorpicker.min.css")?>" rel="stylesheet">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="<?php echo base_url("upload/images/img.jpg")?>" alt="">John Doe
                        ...
                        <li role="presentation" class="dropdown">
                            ...
                            <ul id="menu1" class="dropdown-menu list-unstyled msg_list animated fadeInDown" role="menu">
                                <li>
                                    <a>
                      <span class="image">
                                        <img src="<?php echo base_url("upload/images/img.jpg")?>" alt="Profile Image" />
                                    </span>
                      <span>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="img-container">
                                        <img src="<?php echo base_url("upload/images/picture2.jpg")?>" alt="Picture">
                                    </div>
                                </div>
                                <div class="col-md-3">
...
<!-- input mask -->
<script src="<?php echo base_url("upload/js/input_mask/jquery.inputmask.js")?>"></script>
<!-- knob -->
<script src="<?php echo base_url("upload/js/knob/jquery.knob.min.js")?>"></script>
<!-- range slider -->
<script src="<?php echo base_url("upload/js/ion_range/ion.rangeSlider.min.js")?>"></script>
<!-- color picker -->
<script src="<?php echo base_url("upload/js/colorpicker/bootstrap-colorpicker.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/colorpicker/docs.js")?>"></script>

<!-- image cropping -->
<script src="<?php echo base_url("upload/js/cropping/cropper.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/cropping/main2.js")?>"></script>
<!-- pace -->
