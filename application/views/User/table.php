...
<head>
    ...
    <link href="<?php echo base_url("upload/js/datatables/buttons.bootstrap.min.css");?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url("upload/js/datatables/fixedHeader.bootstrap.min.css");?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url("upload/js/datatables/responsive.bootstrap.min.css");?>" rel="stylesheet" type="text/css" />
...
<script src="<?php echo base_url("upload/js/datatables/dataTables.buttons.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/datatables/buttons.bootstrap.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/datatables/jszip.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/datatables/pdfmake.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/datatables/vfs_fonts.js")?>"></script>
<script src="<?php echo base_url("upload/js/datatables/buttons.html5.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/datatables/buttons.print.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/datatables/dataTables.fixedHeader.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/datatables/dataTables.keyTable.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/datatables/dataTables.responsive.min.js")?>"></script>
<script src="<?php echo base_url("upload/js/datatables/responsive.bootstrap.min.js")?>"></script>
