                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                ...
                                                <ul class="messages">
                                                    <li>
                                                        <img src="<?php echo base_url("upload/images/img.jpg")?>" class="avatar" alt="Avatar">
...
<!-- chart js -->
<script src="<?php echo base_url("upload/js/chartjs/chart.min.js")?>" ></script>

<!-- moris js -->
<script src="<?php echo base_url("upload/js/moris/raphael-min.js")?>"></script>
<script src="<?php echo base_url("upload/js/moris/morris.min.js");?>"></script>
